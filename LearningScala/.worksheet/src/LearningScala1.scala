object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(125); 
  ...
  val myPi : Double = 3.14159265;System.out.println("""myPi  : Double = """ + $show(myPi ));$skip(28); 
  val doubleMyPi = myPi * 2;System.out.println("""doubleMyPi  : Double = """ + $show(doubleMyPi ));$skip(46); 
  println(f"Pi * 2 is about $doubleMyPi%.3f")}
}
