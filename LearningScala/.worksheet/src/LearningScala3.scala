object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  def myToUpper( lowerCase: String) : String = {lowerCase.toUpperCase};System.out.println("""myToUpper: (lowerCase: String)String""");$skip(48); 
  
  val upperCase = myToUpper("colin p clark");System.out.println("""upperCase  : String = """ + $show(upperCase ));$skip(97); 
  
  def transformString( aString: String, f: String => String) : String = {
 	 	f(aString)
  	};System.out.println("""transformString: (aString: String, f: String => String)String""");$skip(101); 
  	
  
  val literalUpperCase = transformString("colin p clark", newString => newString.toUpperCase);System.out.println("""literalUpperCase  : String = """ + $show(literalUpperCase ))}
